...
```
nomad-pack run hashicups --var message="Hola Mundo!"
```
...
balance the Consul service `hashicups-service`, which is the default value
...
- `consul_service_name` (string) - The consul service name for the hashicups
  application
